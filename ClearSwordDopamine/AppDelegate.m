...
- (void)applicationWillResignActive:(UIApplication*)application {
    ...
    // user quits the application and it begins the transition to the background state. Use this method to pause ongoing tasks, disable timers, and invalidate graphics rendering callbacks. Games
...
- (void)applicationDidEnterBackground:(UIApplication*)application {
    ...
    // terminated later. If your application supports background execution, this method is called instead of applicationWillTerminate: when the user quits.
}
